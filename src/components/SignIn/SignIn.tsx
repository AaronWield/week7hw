...
// Very Small Component created inside of the SignIn.tsx Component
//only used to close the popup section -- don't want
//to make 3 new files for this one small feature
